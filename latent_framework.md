...
Project（事業）とは一般的に、特定の目標を達成するために、一定の期間内で遂行される計画的な活動と定義される。  
多くの場合、期日と成果物の設定が前提とされる。

本 Framework では、「期日」を「誕生から死亡まで」「結成から解散まで」「ビッグバンから消滅まで」といった広い時間軸に拡張して捉えることを許容するため、厳密な設定を重視しない。
Project は、完成の有無や継続性によってではなく、語りの衝動（Story）が構文化されたかどうかによって定義される。
そして、それを他者（鑑賞者、顧客、未来の人）に観測されたか、ということを重視する。

Project とは、例えば以下のようなものを指す。

- 個人による芸術品の作成と発表。例えば油絵の個展発表や DJ プレイ
- 複数人による芸術品や娯楽作品の作成と発表。例えば映画やゲーム
- オープンソースプロジェクトの推進
- サークル活動、NPO や NGO の活動
- 起業、営利活動もしくはそれを目的とした商品やシステムの作成
- 順位付け、昇降格のあるスポーツやゲームの大会への参加
- 試験合格や資格取得、技能取得や書籍執筆を目的とした学習や訓練
- 建国、国家運営、内政外交
- 父なる神による天地創造（Creation）

他者に Story を観測させることを目的としない個人の活動（Activity / Hobby）、  
たとえば発表を前提としないお絵描きや、友人とのスポーツは、  
この定義での Project とは異なる（後述する Economy と Force の構成要素が欠けているためである）。
だが、Story によった Project として、扱うことを許容する。

したがって、「続けられない」「維持されない」語りであっても、それが語られた瞬間にProjectとなりうる。  
Project は、完成や継続の有無ではなく、語りの衝動が構文化されたかどうかによって定義される。
