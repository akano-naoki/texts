...
| **Customer（消費者/観察者）** | ☝️ Logic（観測された構造） | どの構文を重視したか、その選択そのものが本人の Story を語ってしまう。受け手でありながら、構文化の鏡像でもある。 |
...
AI や統計は、Economy や Force の構造的把握、言語的特徴の分析、過去のパターンとの比較には有効であり、Flow・Capital・Control・Contract といった構文要素の可視化には一定の補助的機能を果たす。

しかし、Story（とくに Art 内部の Logic / Reframe / Blues）においては、観察者も AI も、語り手の意図とは必ずズレを生じる。
