...
Latent Framework を用いて “感じ取った良さを Story／Economy／Force に分けて言語化する” 練習を重ねると、芸術鑑賞にとどまらず、仕事・学業・研究の現場で次のような効果を得られる可能性がある。
...
Story は、神話、ステートメンhotel、キャッチコピー、憲章、企業 web の設立の目的ページのような文章で観測される。
