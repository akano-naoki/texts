...
他者と関わりのない個人の活動（Activity / Hobby）、例えば発表を前提としないお絵描きや、友人たちと行うスポーツは、
辞書的な意味での Project とはいえない（後述する Economy と Force の要素がない）。
ただこれらは 3 要素のうち Story によった Project として、拡大してこのフレームワークを適用することは可能である。
