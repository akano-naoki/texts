...
Latent Framework（潜在化された構文分析）は、他者が介在する人間の活動（事業:Project）に対し、それを支えている構文を分析、理解、検討する際の補助に用いるフレームワークである。
...
本構文では、「期日」を「誕生から死亡まで」「結成から解散まで」「ビッグバンから消滅まで」といった  
...
また、本構文では、人間以外の存在による行為、
たとえば自然現象や動物の行動などについても、  
それが他者（人間）によって Story として観測・語られ、  
さらに Product（製品）として何らかの価値を認められた場合には、  
