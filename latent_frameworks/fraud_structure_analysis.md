...
- 📣 Propaganda：「『合意の上』『大人の関係』による強制性の ✂️ 言語的隠蔽」
...
- 📣 Propaganda：「広告ではない『本当におすすめ』という虚偽の 🪧 中立性演出（**自覚なき 🎭 Marionette**）」

## 構文的乖離の比較表

| 詐欺手法            | 建前の Story    | 本音の推測 Story    | 主要な乖離ポイント                                                      |
| --------------- | ------------ | -------------- | --------------------------------------------------------------------------- |
| **ポンジスキーム**     | 革新的投資で全員が豊かに | 新規参加者獲得が唯一の収益源 | 📊 Verification（実績データ偽装）<br>💰 Capital（資金の流用）<br>⏳ Cadence（「月末まで倍増」カウントダウン） |
| **カルト的サロン**     | 成長と仲間との出会い   | 依存関係構築による永続収益  | 🔗 Control（相互監視）<br>📣 Propaganda（責任転嫁）<br>⏳ Cadence（「決断は○曜Zoom」煽り）         |
| **貢がせ**         | 特別な絆と関係      | 効率的金銭回収システム    | 👏 Blues（恋愛感情偽装）<br>📏 Measurement（支払能力査定）<br>⏳ Cadence（「今月のNo.1争い」）        |
| **実体なしスタートアップ** | 世界を変える革新的解決策 | 資金調達のみが目的      | 🤔 Prediction（実現性回避）<br>📦 Flow（私的流用）<br>⏳ Cadence（「倒産寸前だから投資を」）            |
| **疑似科学**        | 人類の健康幸福に貢献   | 権威性利用した不安の商品化  | 📊 Verification（偽装検証）<br>🪪 Credential（偽権威）<br>⏳ Cadence（「即効！３日間で実感」）       |
| **やる気ない野党**     | 民主主義を守る使命    | 野党ポジション維持      | ☝️ Logic（責任回避構造）<br>🪏 Labor（政治ショー化）              |
| **オレオレ詐欺**      | 家族愛による緊急支援   | 感情的脆弱性攻撃       | 🪵 Material（個人情報悪用）<br>🔗 Control（時間圧迫）<br>⏳ Cadence（「15分以内に振込」）            |
| **ベンダーロックイン**   | 業務効率と競争力向上   | 移行コスト最大化       | 🤌 Technique（非互換設計）<br>💰 Capital（顧客資産化）           |
| **マルチ商法**       | 夢と経済的自立支援    | 人間関係の商品化       | ☝️ Logic（ピラミッド隠蔽）<br>🪏 Labor（無償勧誘）<br>⏳ Cadence（「今なら上位枠」）                  |
| **情報商材詐欺**      | 成功ノウハウの社会還元  | 成功願望の商品化       | 🪵 Material（無価値情報）<br>💰 Capital（限界費用ゼロ）<br>⏳ Cadence（私が儲かりました。）           |
| **教育虐待**        | 子どもの幸福のため    | 親の承認欲求充足       | 👏 Blues（愛情偽装）<br>🔗 Control（逃避不可）<br>⏳ Cadence（「大学入ったら遊べる」）                  |
