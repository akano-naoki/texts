# Latent Framework から見る、インセプションデッキの解説

## はじめに

インセプションデッキは「プロジェクトの10の質問」として知られるプロジェクト開始前の整理手法です。しかし、多くの現場で「形式的なチェックリスト」として扱われ、本来の価値が見失われています。

**Latent Framework**で構文分析すると、インセプションデッキの真の構造と機能が明確になります。
...
27要素全ての要素を担当するステークホルダーをもれなく列挙することを目指す。詳しいやり方は後段にて記述する。
...
### **質問9**: 何を諦めるのか？
- **☝️ Logicl**: 重要度の分類、優先順位の論理的判断
- **🔗 Control**: ご近所さんの説得、合意形成
...
##### **🪴 Sponsorship（出資）**
- **該当者**: エンジェル投資家、パトロン、ベンチャーキャピタル
- **役割**: リスク共有型の資金提供

##### **📈 Investment（投資）**
- **該当者**: **エンドユーザー**、株主、クラウドファンディング参加者
