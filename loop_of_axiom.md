...
| 分野 | Axiom（絶対的前提） | 具体例 |
|------|------------------|--------|
| 宗教 | 聖典・教義・戒律 | 旧約・新約聖書、コーラン、三蔵経 |
| 原始仏教 | 解脱と八正道・戒律 | 三宝、四諦 |
| 論理学・哲学 | 整合性・推論規則 | 三段論法、弁証法 |
| 自然科学 | 新規性・再現性 | 実験再現性、ピアレビュー |
| 資本主義 | 収益・利益率・成長性 | 会計原則、株主価値最大化 |
| 政治・国家 | 統治制度、憲法 | 三権分立、国民主権、立憲主義 |
...
### 11-1. 多くの分野におけるFaithfulの前提
- 多くの分野では、**既存のAxiom**にFaithfulであることが評価の出発点となる  
  - 例：自然科学では相対性理論が光速不変という新しい命題を導入しつつ、科学Axiom（新規性＋再現性）に忠実で、ニュートン力学と統合された  
- **例外**：美学（と美術）  
  - Axiomそのものの破壊・交代が評価対象になる唯一の領域であり、Radicalが正当化されやすい  



### 11-2. コミュニティや個人のAxiom
- 多くの組織（会社、サークル、政党、宗教団体）には、明文化または暗黙のAxiomが存在する  
- 個人にも「生き方の軸」としてのAxiomが存在しうる  



### 11-3. Faithful一辺倒のリスク
- そのAxiomに多くのメンバーが無批判にFaithfulであり続けると、  
  - 形式化・形骸化する  
  - 外部環境に適応できず制度疲労を起こす  
  - 精神性や象徴性が空洞化する  
...
### 11-4. 推奨される態度バランス
- 多くは**Critical**で向き合い、改善や再解釈を続ける  
- 必要に応じて**Radical**に向き合い、Axiom自体を刷新する  
- 美学・美術は「Axiom破壊の作法」と「破壊から創造への移行」の蓄積があり、他分野の参考になる  



### 11-5. 指針
> 多くの価値体系はFaithfulで支えられるが、それだけでは衰弱する。  
> 持続と発展にはCriticalな姿勢が必要であり、時にRadicalな刷新も避けられない。  
> 美学・美術はそのプロセスのモデルとして有用である。  
